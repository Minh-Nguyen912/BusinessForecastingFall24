...
```
```{r}
#summary: the time series recently is showing fluctuations with higher values. I expect the fluctuation will countinue in the future since the higher demand pattern was set since the middle of 2022 for this product. The best models are SM3 and HW.
```
